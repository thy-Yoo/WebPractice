...
<body>
	...
	<div class="event_subMenu">
		...
		<ul>
			<li class="subMenuTitle"><a id="subMenu_total" href="event_category_all.do" class="selectCategoryMenu">전체</a></li>
			<li class="subMenuTitle"><a id="subMenu_movie" href="event_category_movie.do" class="selectCategoryMenu">영화</a></li>
			<li class="subMenuTitle"><a id="subMenu_theater" href="event_category_theater.do" class="selectCategoryMenu">극장</a></li>
		</ul>
